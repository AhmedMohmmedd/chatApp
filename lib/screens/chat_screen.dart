...
//                         .sendMseag(messageText: messageText!);
//                     // messageTextControler.clear();
...
//     BlocProvider.of<ChatCubit>(context).ggetMseag();
//     // return
...
//         massegeWidghets = state.messabes;
//       }
//       return Expanded(
//         child: ListView(
//           reverse: true,
...
//   const ({this.sender, this.text, required this.isMe});
...
//           Text(
//             '$sender',
//             // BlocProvider.of<ChatCubit>(context).massageSender!,
...
//               child: Text(
//                 '$text ',
//                 // BlocProvider.of<ChatCubit>(context).massageText!,
